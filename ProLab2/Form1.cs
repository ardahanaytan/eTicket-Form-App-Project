        ...
        private void buttonAracEkle_Click(object sender, EventArgs e)
        {
            ...
            foreach (Company x in company.companyList)
            {
                if (x.userName == company_name)
                {
                    ...
                    temp.arac_olustur(x.getUserName(), arac_id, yakit_turu, koltuk_no, koltuk_no / 2, sefer_no, "Pazartesi", "Monday");
                    temp.arac_olustur(x.getUserName(), arac_id, yakit_turu, koltuk_no, koltuk_no / 2, sefer_no, "Salý", "Tuesday");
                    temp.arac_olustur(x.getUserName(), arac_id, yakit_turu, koltuk_no, koltuk_no / 2, sefer_no, "Çarþamba", "Wednesday");
                    temp.arac_olustur(x.getUserName(), arac_id, yakit_turu, koltuk_no, koltuk_no / 2, sefer_no, "Perþembe", "Thursday");
                    temp.arac_olustur(x.getUserName(), arac_id, yakit_turu, koltuk_no, koltuk_no / 2, sefer_no, "Cuma", "Friday");
                    temp.arac_olustur(x.getUserName(), arac_id, yakit_turu, koltuk_no, koltuk_no / 2, sefer_no, "Cumartesi", "Saturday");
                    temp.arac_olustur(x.getUserName(), arac_id, yakit_turu, koltuk_no, koltuk_no / 2, sefer_no, "Pazar", "Sunday");
